...
export default function CreateListing() {
    ...
    useEffect(()=>{
        // since we can not make useEffect async hence we created another function listing here
        const fetchListing = async()=>{
            const listingId = params.id  // id is from app.jsx /update-listing/:id(name should be same like here id)
                ...
                <div className="flex flex-col flex-1 gap-4">
                    ...
                    <div className='flex gap-4'>
                        <input 
                            ...
                            multiple 
                        />
                        <button disabled={uploading} type='button' onClick={handleImageSubmit} className='p-3 text-green-700 border border-gray-700 rounded 
